...
import {getGrevienceList, addGrevience, acknowledged} from '../redux/slices/GrevienceSection';
import RadioForm, {
  RadioButton,
  RadioButtonInput,
  RadioButtonLabel,
...
let _role = [
  ...
  {label: 'East', value: 1, key: 'east'},
  {label: 'West', value: 2, key: 'west'},
  {label: 'North', value: 3, key: 'north'},
  {label: 'South', value: 4, key: 'south'},
];
...
export function Grevience({navigation}) {
  ...
  const handleAcknowledge = (id) => {
    let token = state.token.jwtToken;
    dispatch(acknowledged(id, token,(err,msg)=>{
      if (err) {
  ...
  return (
    <Block flex center style={styles.home}>
      <ImageBackground
        ...
        <Block flex middle>
          <Block style={{...styles.registerContainer, height: height * 0.7}}>
                      ...
                      <View style={styles.modalView}>
                        ...
                        {!gervienceState.isLoading ? (
                          ...
                          gervienceState.list.length ? (
                            ...
                            <Text style={{marginTop:20}}>No Greviences Found</Text>
                          )
                        ) : (
